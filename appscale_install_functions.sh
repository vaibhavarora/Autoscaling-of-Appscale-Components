...
installzookeeper()
{
    ...
    wget http://appscale.cs.ucsb.edu/appscale_files/zookeeper-3.4.0.tar.gz || exit 1
...
{
    cd ${DESTDIR}/usr/local/
    wget http://appscale.cs.ucsb.edu/appscale_files/berkeley_upc-2.12.1.tar.gz || exit 1
...
installdwssa()
{
    wget http://appscale.cs.ucsb.edu/appscale_files/dwssa.tar.gz || exit 1
